...
var fetchRSSFeeds = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var feeds, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, rssService_1.getRSSFeeds)()];
            case 1:
                feeds = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Error fetching RSS feeds:", error_1);
